...
displayTitle "Molotov" "Installe l'application pour regarder la télévision."
	...
	TEST_SUDO; sudo wget -P $APP_PATH $APP_URL; ERROR
...
#Exec=$(export XDG_DATA_DIRS="$HOME/.local/share/"; /usr/share/molotov/Molotov.AppImage)
#Terminal=false
#X-AppImage-Version=1.1.2
#X-AppImage-BuildId=5952d0b0-c5de-11a6-0087-55675d1f76a7
#Categories=AudioVideo;
#X-Desktop-File-Install-Version=0.22
#X-AppImage-Comment=Generated by /tmp/.mount_27TaTz/AppRun
#EOF 
	echo ""
